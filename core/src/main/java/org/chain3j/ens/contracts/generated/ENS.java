...
public final class ENS extends Contract {
    ...
    private ENS(String contractAddress, chain3j chain3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, chain3j, credentials, gasPrice, gasLimit);
    }

    private ENS(String contractAddress, chain3j chain3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
    ...
    public RemoteCall<TransactionReceipt> setSubnodeOwner(byte[] node, byte[] label, String owner) {
        Function function = new Function(
                "setSubnodeOwner",
                Arrays.<Type>asList(new org.chain3j.abi.datatypes.generated.Bytes32(node),
                new org.chain3j.abi.datatypes.generated.Bytes32(label),
                new org.chain3j.abi.datatypes.Address(owner)),
    ...
    public RemoteCall<TransactionReceipt> setTTL(byte[] node, BigInteger ttl) {
        Function function = new Function(
                "setTTL",
                Arrays.<Type>asList(new org.chain3j.abi.datatypes.generated.Bytes32(node),
                new org.chain3j.abi.datatypes.generated.Uint64(ttl)),
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
    ...
    public RemoteCall<TransactionReceipt> setResolver(byte[] node, String resolver) {
        Function function = new Function(
                "setResolver",
                Arrays.<Type>asList(new org.chain3j.abi.datatypes.generated.Bytes32(node),
                new org.chain3j.abi.datatypes.Address(resolver)),
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
    ...
    public static RemoteCall<ENS> deploy(chain3j chain3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return deployRemoteCall(ENS.class, chain3j, credentials, gasPrice, gasLimit, BINARY, "");
    }

    public static RemoteCall<ENS> deploy(chain3j chain3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return deployRemoteCall(ENS.class, chain3j, transactionManager, gasPrice, gasLimit, BINARY, "");
    }

    public static ENS load(String contractAddress, chain3j chain3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return new ENS(contractAddress, chain3j, credentials, gasPrice, gasLimit);
    }

    public static ENS load(String contractAddress, chain3j chain3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return new ENS(contractAddress, chain3j, transactionManager, gasPrice, gasLimit);
    }
