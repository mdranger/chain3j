...
public interface Ethereum {
    ...
    Request<?, org.chain3j.protocol.core.methods.response.EthSendTransaction> ethSendTransaction(
            org.chain3j.protocol.core.methods.request.Transaction transaction);

    Request<?, org.chain3j.protocol.core.methods.response.EthSendTransaction> ethSendRawTransaction(
    ...
    Request<?, EthLog> ethGetLogs(org.chain3j.protocol.core.methods.request.EthFilter ethFilter);
