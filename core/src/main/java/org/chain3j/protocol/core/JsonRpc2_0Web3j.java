 ...
 */
public class JsonRpc2_0Web3j implements chain3j {
    ...
    @Override
    public Request<?, org.chain3j.protocol.core.methods.response.EthSendTransaction>
            ethSendTransaction(
        ...
        return new Request<>(
                ...
                web3jService,
                org.chain3j.protocol.core.methods.response.EthSendTransaction.class);
    }
    ...
    @Override
    public Request<?, org.chain3j.protocol.core.methods.response.EthCall> ethCall(
            Transaction transaction, DefaultBlockParameter defaultBlockParameter) {
        return new Request<>(
                "eth_call",
                Arrays.asList(transaction, defaultBlockParameter),
                web3jService,
                org.chain3j.protocol.core.methods.response.EthCall.class);
    }
