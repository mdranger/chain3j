    ...
    public void testBuildEventConstantMultipleValueReturn() throws Exception {
        ...
        String expected =
                "class testClass {\n"
                        ...
                        + "  }\n"
                        + "\n"
                        + "  public rx.Observable<TransferEventResponse> transferEventObservable(org.chain3j.protocol.core.methods.request.EthFilter filter) {\n"
                        + "    return chain3j.ethLogObservable(filter).map(new rx.functions.Func1<org.chain3j.protocol.core.methods.response.Log, TransferEventResponse>() {\n"
                        + "      @java.lang.Override\n"
                        ...
                        + "    org.chain3j.protocol.core.methods.request.EthFilter filter = new org.chain3j.protocol.core.methods.request.EthFilter(startBlock, endBlock, getContractAddress());\n"
