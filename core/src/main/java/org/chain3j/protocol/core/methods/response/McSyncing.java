 ...
 */
public class McSyncing extends Response<McSyncing.Result> {

    @Override
    @JsonDeserialize(using = McSyncing.ResponseDeserialiser.class)
    public void setResult(McSyncing.Result result) {
