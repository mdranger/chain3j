 ...
 * details on additional Parity fields present in McBlock.</p>
 */
public class McBlock extends Response<McBlock.Block> {

    @Override
    @JsonDeserialize(using = McBlock.ResponseDeserialiser.class)
