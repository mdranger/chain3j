...
public interface Chain3jRx {
     ...
     *         blockchain
     */
    Observable<String> mcBlockHashObservable();
     ...
     */
    Observable<String> mcPendingTransactionHashObservable();
     ...
     */
    Observable<McBlock> blockObservable(boolean fullTransactionObjects);
     ...
     */
    Observable<McBlock> replayBlocksObservable(
     ...
     */
    Observable<McBlock> catchUpToLatestBlockObservable(
     ...
     */
    Observable<McBlock> catchUpToLatestAndSubscribeToNewBlocksObservable(
            DefaultBlockParameter startBlock, boolean fullTransactionObjects);
