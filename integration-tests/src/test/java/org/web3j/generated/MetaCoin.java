 ...
 *
 * <p>Generated with chain3j version 3.3.1.
 */
public class MetaCoin extends Contract {
    ...
    public RemoteCall<BigInteger> getBalanceInEth(String addr) {
        final Function function = new Function("getBalanceInEth", 
                Arrays.<Type>asList(new org.chain3j.abi.datatypes.Address(addr)), 
    ...
    public RemoteCall<TransactionReceipt> sendCoin(String receiver, BigInteger amount) {
        final Function function = new Function(
                "sendCoin", 
                Arrays.<Type>asList(new org.chain3j.abi.datatypes.Address(receiver), 
                new org.chain3j.abi.datatypes.generated.Uint256(amount)), 
