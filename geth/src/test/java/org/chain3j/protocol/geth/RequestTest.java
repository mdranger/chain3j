...
public class RequestTest extends RequestTester {
    private Geth chain3j;

    @Override
    protected void initWeb3Client(HttpService httpService) {
        chain3j = Geth.build(httpService);
    }
    ...
    public void testPersonalImportRawKey() throws Exception {
        ...
        chain3j.personalImportRawKey(rawKey,password).send();
    ...
    public void testPersonalLockAccount() throws Exception {
        ...
        chain3j.personalLockAccount(accountId).send();
    ...
    public void testPersonalSign() throws Exception {
        //CHECKSTYLE:OFF
        chain3j.personalSign("0xdeadbeaf", "0x9b2055d370f73ec7d8a03e965129118dc8f5bf83", "hunter2").send();
    ...
    public void testPersonalEcRecover() throws Exception {
        //CHECKSTYLE:OFF
        chain3j.personalEcRecover("0xdeadbeaf","0xa3f20717a250c2b0b729b7e5becbff67fdaef7e0699da4de7ca5895b02a170a12d887fd3b17bfdce3481f10bea41f45ba9f709d39ce8325427b57afcfc994cee1b").send();
